...
xgb_mu_50 = xgb_mu_200 = xgb_mu_400 = xgb_mu_800 = xgb.XGBRegressor()
xgb_Pcv_50 = xgb_Pcv_200 = xgb_Pcv_400 = xgb_Pcv_800 = xgb.XGBRegressor()


xgb_yield = xgb.XGBRegressor()
xgb_tensile = xgb.XGBRegressor()
...
if __name__ == "__main__":
    ...
    mu_grid_model_list = [xgb_mu_50, xgb_mu_200, xgb_mu_400, xgb_mu_800]
    ...
    Pcv_grid_model_list = [xgb_Pcv_50, xgb_Pcv_200, xgb_Pcv_400, xgb_Pcv_800]
    ...
    yield_grid_model_list = [xgb_yield]
    ...
    tensile_grid_model_list = [xgb_tensile]
    ...
    XGB_grid_param = {'mu': mu_grid_param,
            'Pcv': Pcv_grid_param,
            'yield': yield_grid_param,
            'tensile': tensile_grid_param}

    with open('grid_param_output\\xgb_grid_param.txt', 'w') as f:
        json.dump(XGB_grid_param,f)
